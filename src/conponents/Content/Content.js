...
const MyContent = () => {
  ...
  useEffect(() => {
    const options = {
      strings:['积极向上', "创新能力强", "喜欢宅","注重细节","喜欢团队合作","持续学习","但总有些小焦虑",],
      typeSpeed : 100,
      backSpeed : 100,
      backDelay : 1500,
      loop : true
  ...
  return() => {
   ...
   return (
     <div style={{width:"60%"}}>
         ...
         <div>
           ...
           >
             ...
             <Paragraph className={cardTheme}>
               <div style={{ paddingLeft: "30px", fontWeight: "580" }}>
                 ...
                 >
                   <h className={worldTheme}>王康勋，</h>来自 河南商丘，
                   <br />
                   一个<span className={worldTheme} ref={textElementRrf}></span>的人
                   <br />
           ...
           >
             ...
             >
               ...
               <div style={{width: "490.2px", height: "298px", display: "flex",paddingLeft:"15px" }}>
                 <div
                   className={cardsTheme}
                   style={{
           ...
           >
             ...
             <div style={{ width: "83%", paddingLeft: "30px" }}>
               ...
               >
                 &nbsp;&nbsp;&nbsp;&nbsp;学习以上内容后，又深入学习了Ajax、Redux、Axios、Webpack、Nginx等技术，对前端有了更深刻的理解。<br/>&nbsp;&nbsp;&nbsp;&nbsp;Ajax实现了异步数据交互，让网页
             ...
             <div style={{ paddingLeft: "30px", paddingTop: "50px" }}>
               ...
               <Carousel autoplay style={{ paddingTop: "50px" }}>
                 <div style={{}}>
                   <img
                     style={contentStyle}
                     src={require("../../../src/assets/vite.jpg")}
                   />
                 </div>
                 <div>
                   <img
                     style={contentStyle}
                     src={require("../../../src/assets/TypeScript.jpg")}
                   />
                 </div>
                 <div>
                   <img
                     style={contentStyle}
                     src={require("../../../src/assets/jQuery.jpg")}
                   />
                 </div>
                 <div>
                   <img
                     style={contentStyle}
                     src={require("../../../src/assets/axios.jpg")}
                   />
                 </div>
               </Carousel>
               <Divider  orientation="left" style={{paddingTop:"100px",fontSize:'20px',zIndex:'3'}}>基础部分</Divider>
               <Collapse
                className={cardTheme}
               ...
               />
               <Divider orientation="left" style={{fontSize:'20px',zIndex:'3'}}>专业阶段</Divider>
               <Collapse
                 style={{fontSize:'15px',zIndex:'3'}}
                 items={[
                   {
                    // style ={{}},
                     key: "1",
                     label: "重要部分",
                     children: <p >1.前端框架与库：如React、Vue和Angular。常用前端库：jQuery、Axios等<br/>
                      2.版本控制：学习Git等版本控制工具，掌管代码的管理和维护。<br/>
                      3.性能优化与SEO：学习前端优化技巧，如代码压缩、缓存策略、图片优化等。了解SEO的基本原则，掌握如何编写有利于搜索引擎索引的HTML代码。
                     </p>,
                   },
                 ]}
               />
               <Divider orientation="left"  style={{fontSize:'20px',zIndex:'3'}}>项目阶段</Divider>
               <Collapse
                 style={{fontSize:'15px',zIndex:'3'}}
                 items={[
                   {
                     key: "1",
                     label: "项目阶段",
                     children: <p>1.项目实践：参与实际项目开发，将所学知识应用于实践。<br/>
       ...
       <Footer
        className={cardColor}
        style={{ height: "150px", position:'absolute',bottom:'-254.3%',width:'100%' }}
      >
        <div
