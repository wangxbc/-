      ...
      >
        ...
        >
          ...
          >
            ...
            <div
              style={{ position: "relative", left: "20%", paddingTop: "30px" }}
            >
              <Image
                style={{
                  width: "500px",
            ...
            <div style={{paddingTop:'30px',display:'flex',width:"900px"}}>
              ...
              <div style={{width:"300px",height:'300px',position:'absolute',top:"78%",left:"88%",display:"flex"}}> 
                <Image
                  style={{
                    width: "270px",
                    height: "200px",
                ...
                /><div style={{width:'150px',height:'50px'}}><p style={{paddingTop:'8px',lineHeight:'1.5',paddingLeft:'5px',width:'150px'}}>漫步于拙政园，风拂过荷叶，诗意在心中泛起涟漪。那错落有致的亭台轩榭，是岁月雕琢出的精致。虎丘的塔影，静静诉说着往昔的辉煌，让人不禁心生敬畏。</p></div></div>
          </div>
          <div
            style={{
              position: "relative",
          ...
          >
            ...
            <div
              style={{ position: "relative", left: "0%", paddingTop: "120px", }}
            >
              <p style={{position:'absolute',top:"13.5%",left:"7%",width:'500px',lineHeight:"1.5",fontWeight:'520',fontSize:"15px"}}>在武汉这座充满活力的城市，我度过了一段难忘的旅程。这座城市不仅有着丰富的历史文化，还有着独特的人文气息。</p>
              <p style={{position:'absolute',top:"102%",left:"7%",width:'400px',lineHeight:"1.5",fontWeight:'520'}}>夜晚的黄鹤楼金碧辉煌。</p>
            <Image
                  style={{
                    width: "260px",
                    height: "260px",
          ...
          >
            ...
            <div style={{display:'block',position:'absolute',top:'280%',width:"400px"}}> 
              <Image
                  style={{
                    width: "260px",
                    height: "260px",
                ...
                />
                 <p style={{position:'absolute',top:'102%',left:'0%',width:'300px',fontSize:"15px",lineHeight:"1.5"}}>西安，这座历史悠久的城市，是中华文明的重要发祥地之一。在西安的旅行，仿佛是一次穿越时空的旅程</p>
                 <p style={{position:'absolute',top:'-10%',left:'24%',width:'500px',fontSize:"15px",lineHeight:"1.5"}}>踏上西安的土地，走进历史的长河。鼓楼，那巍峨的身躯，承载着岁月的厚重。登上楼顶，微风拂过，仿佛听见了古时的钟鼓之声。它是历史的见证者，静静讲述着这座城的沧桑变迁。</p>
                </div>
